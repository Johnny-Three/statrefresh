...
func get() {
	...
	response, err := http.Get("http://192.168.101.127:8081/getstatprogress?seq=1000")
	if err != nil {
...
func post(t string) {
	...
	case "postform":
		...
		resp, err := http.PostForm("http://127.0.0.1:8081/refresh",
	...
	case "post-json":
		...
		*/
		...
		resp, err := http.Post("http://192.168.101.127:8081/refresh", "application/json", body)
